 ...
 * Use the {@link FragmentMenu2#newInstance} factory method to
...
public class FragmentMenu2 extends Fragment {
    ...
    public static FragmentMenu2 newInstance(String param1, String param2) {
        FragmentMenu2 fragment = new FragmentMenu2();
